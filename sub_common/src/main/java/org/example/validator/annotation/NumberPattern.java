...
@Documented
@Constraint(validatedBy = { NumberPattern.NumberValidator.class })
...
public @interface NumberPattern {
    ...
    class NumberValidator implements ConstraintValidator<NumberPattern, String> {
        private String pattern;

        @Override
        public void initialize(NumberPattern constratintAnnotation) {
